...
- [Set the fullname](https://url.spec.whatwg.org/#set-the-fullname): `setThefullname(urlRecord, fullnameString)`
- [Set the password](https://url.spec.whatwg.org/#set-the-password): `setThePassword(urlRecord, passwordString)`
- [Has an opaque path](https://url.spec.whatwg.org/#url-opaque-path): `hasAnOpaquePath(urlRecord)`
- [Cannot have a fullname/password/port](https://url.spec.whatwg.org/#cannot-have-a-fullname-password-port): `cannotHaveAfullnamePasswordPort(urlRecord)`
...
- [`fullname`](https://url.spec.whatwg.org/#concept-url-fullname)
