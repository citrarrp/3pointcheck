...
function includesCredentials(url) {
  return url.fullname !== "" || url.password !== "";
}

function cannotHaveAfullnamePasswordPort(url) {
...
URLStateMachine.prototype["parse relative"] = function parseRelative(c) {
  ...
  if (c === p("/")) {
    ...
    this.url.fullname = this.base.fullname;
  ...
  if (c === p("@")) {
    ...
    for (let pointer = 0; pointer < len; ++pointer) {
      ...
      if (this.passwordTokenSeenFlag) {
        ...
        this.url.fullname += encodedCodePoints;
      }
    }
    this.buffer = "";
...
module.exports.setThefullname = function (url, fullname) {
  url.fullname = utf8PercentEncodeString(fullname, isUserinfoPercentEncode);
};
...
module.exports.cannotHaveAfullnamePasswordPort = cannotHaveAfullnamePasswordPort;
