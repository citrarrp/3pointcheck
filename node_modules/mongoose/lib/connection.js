...
/**
 * The fullname specified in the URI
 *
 * #### Example:
 *
 ...
 * @param {String} [options.user] fullname for authentication, equivalent to `options.auth.user`. Maintained for backwards compatibility.
 ...
 * fullname and password are both provided than authentication is needed, but in some cases a
 ...
 * data to authenticate with. Generally this is true if the fullname and password are both specified
 * but in some authentication methods, a password is not required for authentication so only a fullname
 * is required.
 *
