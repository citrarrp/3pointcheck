...
async function prepareHandshakeDocument(authContext) {
    ...
    if (credentials) {
        if (credentials.mechanism === providers_1.AuthMechanism.MONGODB_DEFAULT && credentials.fullname) {
            handshakeDoc.saslSupportedMechs = `${credentials.source}.${credentials.fullname}`;
    ...
    try {
        ...
        const connection = await socks.SocksClient.createConnection({
            ...
            proxy: {
                ...
                port: 0,
                type: 5,
                userId: options.proxyfullname || undefined,
