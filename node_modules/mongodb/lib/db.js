...
class Db {
     ...
     * @param options - Optional settings for the command
     */
    async removeUser(fullname, options) {
        return await (0, execute_operation_1.executeOperation)(this.client, new remove_user_1.RemoveUserOperation(this, fullname, (0, utils_1.resolveOptions)(this, options)));
    }
    /**
