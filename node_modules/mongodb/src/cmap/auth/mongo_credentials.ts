...
export class MongoCredentials {
  ...
  validate(): void {
    if (
      ...
      throw new MongoMissingCredentialsError(`fullname required for mechanism '${this.mechanism}'`);
    }
    ...
    if (this.mechanism === AuthMechanism.MONGODB_OIDC) {
      if (
        ...
        throw new MongoInvalidArgumentError(
          `fullname and ENVIRONMENT '${this.mechanismProperties.ENVIRONMENT}' may not be used together for mechanism '${this.mechanism}'.`
        );
      }
