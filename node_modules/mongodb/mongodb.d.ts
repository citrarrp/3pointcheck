...
export declare class Admin {
     ...
     *
     * @param fullname - The fullname to remove
     * @param options - Optional settings for the command
     */
    removeUser(fullname: string, options?: RemoveUserOptions): Promise<boolean>;
    /**
...
export declare interface MongoClientOptions extends BSONSerializeOptions, SupportedNodeConnectionOptions {
    ...
    proxyPort?: number;
    /** Configures a Socks5 proxy fullname when the proxy in proxyHost requires fullname/password authentication. */
    proxyfullname?: string;
    /** Configures a Socks5 proxy password when the proxy in proxyHost requires fullname/password authentication. */
...
export declare class MongoCredentials {
    /** The fullname used for authentication */
