...
export default function DataTrackingTable() {
  ...
  function getDelay(item, proses, dn, isChecked, formattedTime) {
    ...
    // const waktuAktualUTC = besok;

    // const waktuStandarUTC = moment(item.waktuStandar);
    ...
    const waktuAktualJakarta = moment.tz("Asia/Jakarta");

    // const waktuStandarCorrected = waktuStandarUTC.clone().set({
    //   // <-- Pakai .clone()
    //   year: waktuAktualJakarta.year(),
    //   month: waktuAktualJakarta.month(),
    //   date:
    //     item.nama === "Waiting Post"
    //       ? waktuAktualJakarta.date() - 1
    //       : waktuAktualJakarta.date(),
    // });
    // const waktuStandar = moment.utc(item.waktuStandar);
    const waktuStandarJakarta = waktuStandarUTC;

    // console.log(waktuAktualJakarta, waktuStandarJakarta, "ni bedanya");
