...
export default function Home() {
  ...
  const { data: dataTracking } = useSWR(
  ...
  const filteredTrackingData = useMemo(() => {
    ...
    // Filter hanya proses wrapping dan departure truck
    const filtered = dataTracking.filter((item) => {
      ...
      const itemDay = moment(item.tanggal).format("YYYY-MM-DD");
    ...
    console.log(filtered, uniqueMap, "tes");
  ...
  const handleSelectDate = (date) => {
    ...
    // Kalau kamu pakai komponen datepicker, pastikan update view-nya juga
  };
